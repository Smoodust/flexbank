...
Изменения вступают в силу с 22 декабря 2022 года.""",r".\Tariffes.jpg"),
...
Тренд по улучшению условий хранения обусловлен развитием независимых от иностранной инфраструктуры инструментов по размещению валюты.""",r".\Save.jpg")}
